...
+ (SRDejalActivityView *)currentActivityView;
{
...
+ (SRDejalActivityView *)activityViewForView:(UIView *)addToView;
{
...
+ (SRDejalActivityView *)activityViewForView:(UIView *)addToView withLabel:(NSString *)labelText;
{
...
+ (SRDejalActivityView *)activityViewForView:(UIView *)addToView withLabel:(NSString *)labelText width:(NSUInteger)aLabelWidth;
{
...
- (SRDejalActivityView *)initForView:(UIView *)addToView withLabel:(NSString *)labelText width:(NSUInteger)aLabelWidth;
{
...
@implementation SRDejalWhiteActivityView
...
@implementation SRDejalBezelActivityView
...
@implementation SRDejalKeyboardActivityView
...
+ (SRDejalKeyboardActivityView *)activityView;
{
...
+ (SRDejalKeyboardActivityView *)activityViewWithLabel:(NSString *)labelText;
{
    UIView *keyboardView = [[UIApplication sharedApplication] keyboardView];
    ...
    if (!keyboardView)
        ...
        return (SRDejalKeyboardActivityView *)[self activityViewForView:keyboardView withLabel:labelText];
}
